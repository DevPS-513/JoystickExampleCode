...
class Joystick
{
  public:
    Joystick(	int pwm1_pin,		  int dir1_pin, 	int pwm2_pin, 	int dir2_pin,
				      int x_axis_min, 	int x_axis_max, int y_axis_min,	int y_axis_max, 
				      float theta_range, int h_center,  float sensor_wavenumber,
  ...
  // Specify resistance of each channel
  // This allows estimation of maximum current to
  // throttle drive commands.
  ...
  // max_drive_float currently not implemented
